...
Layered so each piece is usable on its own:
    ...
    theme     colours and the dark stylesheet
    settings  every tunable value, and the dialog that edits them
    chart_items  the pyqtgraph primitives that paint the charts
    panels    every widget as a dockable panel
